...
public class VueTableauHonneur extends Vue {
	...
	public void activerControles()
	{
		...
		AnchorPane blason = new BadgeDragon().bouclierRond().dragonEasternAuCentre().danceursEnBas();
		/*blason.setPrefHeight(200);
		blason.setPrefWidth(166);
		blason.setStyle("-fx-background-color: red");*/
		
		
		AnchorPane espaceTravail = (AnchorPane)lookup("#espace-travail");
		espaceTravail.getChildren().add(blason);
		
		/*ImageView formeBlason = new ImageView();
		formeBlason.setImage(new Image("vue/badge/armoirie.png"));
		blason.getChildren().add(formeBlason);
		
		ImageView dragonEastern = new ImageView();
		dragonEastern.setImage(new Image("vue/badge/dragonEastern.png"));
		blason.getChildren().add(dragonEastern);*/
